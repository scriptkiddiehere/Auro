        ...
        <div className="local-video">
          {props.startMeetingComponent.state.selfTrack ? (
            <Suspense fallback={<SmallSuspense />}>
              <VideoPlayer
              isLocal={true}
                track={props.startMeetingComponent.state.selfTrack}
              />
            </Suspense>
          ) : (
            <Suspense fallback={<SmallSuspense />}>
        ...
        <div className="right-wrap">
          <div className="joinMeeting">
            ...
            >
              ...
              <button>
                {props.startMeetingComponent.props.t("join-meet")}
              </button>
            </form>
            {process.env.REACT_APP_IS_ADVANCE_OPTIONS_REQUIRED === "1" && (
              <div className="advancedSettingButton">
                <button
                  onClick={props.startMeetingComponent.openAdvanceOptions}
                >
                  <div className="advancedSettingContainer">
                    ...
                    <div className="advancedSettingContent">
                      ...
                      <p>
                        {props.startMeetingComponent.props.t("advance-notice")}
                      </p>
                    </div>
                  </div>
                </button>
          ...
          {props.startMeetingComponent.state.advanceOptionOpen ? (
            <Suspense fallback={<SmallSuspense />}>
              <AdvanceSetting
                startMeetingComponent={props.startMeetingComponent}
              />
            </Suspense>
          ) : null}
          <div
...
export default StartMeetingDesktop;
